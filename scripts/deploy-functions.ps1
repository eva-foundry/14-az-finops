...
# Smoke test: NormalizedCosts with the new fallback columns
Write-Host "`nSmoke test — Pre-APIM rows:" -ForegroundColor Cyan
$q = "NormalizedCosts() | where MeterCategory has 'API Management' | project Date, EffectiveCallerApp, EffectiveCostCenter, EffectiveEnvironment, CostInBillingCurrency | take 5"

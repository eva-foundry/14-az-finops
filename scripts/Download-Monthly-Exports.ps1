...
<#
.SYNOPSIS
    Download and decompress all monthly exports for specified subscription
...
.PARAMETER StorageAccountName
    Storage account containing exports (default: marcosandboxfinopshub)

.PARAMETER ContainerName
    Storage container (default: costs)

.PARAMETER OutputDir
    Output directory for downloaded files (default: output\{SubscriptionName}-historical)
...
.EXAMPLE
    ...
    .\Download-Monthly-Exports.ps1 -SubscriptionId "802d84ab-..." -SubscriptionName "EsPAICoESub" -CombineFiles
...
if ([string]::IsNullOrEmpty($OutputDir)) {
    $OutputDir = "I:\eva-foundation\14-az-finops\output\$SubscriptionName-historical"
}
...
Write-Host "[INFO] $SubscriptionName Monthly Export Download & Processing" -ForegroundColor Cyan
